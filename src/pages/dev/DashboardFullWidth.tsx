...
export default function DashboardFullWidth() {
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground">Dev: Full Width Layout</h1>
        <p className="text-muted-foreground">Testing all card styles in a single-column stacked layout</p>
      </div>
